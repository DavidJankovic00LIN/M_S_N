...
export default function Hero() {
  ...
  return (
    <div id="hero" className="relative hero min-h-screen w-full overflow-hidden">
      {/* Wrapper za pozadine */}
      <div
        id="hero-bg-wrapper"
      ...
      >
        {images.map((image, index) => (
          <div
            key={image}
            className={`hero-slide absolute inset-0 w-full h-full bg-cover bg-center transition-all duration-1000 ${
       ...
       <div className="relative z-20 flex flex-col items-center justify-center text-center h-full px-4">
                   <div className="bg-white/20 p-8 w-[450px] rounded-lg shadow-xl border border-white/20 mt-20">
