    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 bg-white pb-20" style={{ paddingTop: '200px' }}>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-gray-700 font-[Inter]">
              U slučaju da bilo koja odredba ovih Uslova bude proglašena ništavnom ili nevažećom, to neće uticati na valjanost preostalih odredbi.
              Strane će sporove pokušati da reše mirnim putem, a ukoliko to nije moguće, nadležan je stvarno nadležni sud u Republici Srbiji.
            </p>
          </section>
